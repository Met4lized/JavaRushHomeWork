...
public class Solution {
    ...
    public static void readKeyFromConsoleAndInitPlanet() throws IOException {
        ...
        if (data.equals(Planet.SUN))thePlanet = Sun.getInstance();
        else if (data.equals(Planet.EARTH))thePlanet = Earth.getInstance();
        else if (data.equals(Planet.MOON))thePlanet = Moon.getInstance();
        else thePlanet = null;
